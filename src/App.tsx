...
import SmartCityCesium from './demos/SmartCityCesium'

const demos = [
  { path: '/smart-city', label: '智慧城市 (Cesium)' },
...
function SmartCityCesiumDemo() {
  return <SmartCityCesium />
}
  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
        <Routes>
          <Route path="/" element={<Navigate to="/smart-city" replace />} />
          <Route path="/smart-city" element={<SmartCityCesiumDemo />} />
